...
train_data = pd.read_csv("C:/01_Projects/09_CriticalFormulasandTools/PythonScripts/Kaggle_HousePrices/train.csv")
test_data = pd.read_csv("C:/01_Projects/09_CriticalFormulasandTools/PythonScripts/Kaggle_HousePrices/test.csv")
...
# MiscVal have weak correlation to price sold